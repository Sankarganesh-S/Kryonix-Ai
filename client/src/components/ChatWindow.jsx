...
import { Menu, Sun, Moon, ChevronDown, Sparkles } from 'lucide-react'
...
export default function ChatWindow({ chat, loading, onSend, onStop, onUpload, onRegenerate, sidebarOpen, onToggleSidebar, model, onModel, modelOptions, theme, onTheme }) {
  ...
  const isThinking = loading && !chat?.messages?.at(-1)?.streaming
    ...
    <div className="chat-shell">
      <header className="chat-header">
        <div className="chat-header-left">
          ...
          <button onClick={onToggleSidebar} className="header-icon-btn hamburger-btn" title="Menu">
            <Menu size={22}/>
          </button>
        ...
        <div className="chat-header-title">
          ...
          <span>{chat?.title || 'Kryonix AI'}</span>
        </div>
      ...
      <div className="chat-messages">
        {isEmpty ? (
          <div className="chat-empty">
            ...
            <p className="chat-empty-sub">Ask anything — I'll give you a direct, helpful answer.</p>
